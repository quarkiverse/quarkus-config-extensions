...
public class GitOrdinaloConfigSourceTest {

    private static final String TEST_NAME = "ordinal";
    ...
    private static final Runnable BEFORE_ALL = () -> {
        ...
        try {
            ...
            var sourceURL = Thread.currentThread().getContextClassLoader().getResource("remote-ordinal.properties");
    ...
    static final QuarkusUnitTest unitTest = new QuarkusUnitTest()
            ...
            .setArchiveProducer(() -> {
                return ShrinkWrap.create(JavaArchive.class)
                        ...
                        .addAsResource("remote-ordinal.properties");
            });
    ...
    public void testTheConfigValue() {
        var cfg1 = ConfigProvider.getConfig().getOptionalValue("a.test.key", String.class);
        assertThat(cfg1).isNotEmpty().contains("the used value");

        var cfg2 = ConfigProvider.getConfig().getOptionalValue("another.test.key", String.class);
        assertThat(cfg2).isNotEmpty().contains("the used value");
    }
}
