...
public class GitMasterSwitchConfigSourceTest {

    private static final String TEST_NAME = "master";
    ...
    private static final Runnable BEFORE_ALL = () -> {
        ...
        try {
            ...
            var sourceURL = Thread.currentThread().getContextClassLoader().getResource("remote-master.properties");
    ...
    static final QuarkusUnitTest unitTest = new QuarkusUnitTest()
            ...
            .setArchiveProducer(() -> {
                return ShrinkWrap.create(JavaArchive.class)
                        ...
                        .addAsResource("remote-master.properties");
            });
    ...
    public void testTheConfigValue() {
        ...
        assertThat(cfg).isNotEmpty().contains("the used value");
    }
}
